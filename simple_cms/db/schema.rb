...
ActiveRecord::Schema.define(version: 20170829030149) do
  ...
  create_table "pages_users", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.integer "page_id"
    t.index ["user_id", "page_id"], name: "index_pages_users_on_user_id_and_page_id", using: :btree
  end
